...
public class ContextType extends AbstractSoftEnum {
    private final ContextInfectivityClass infectivityClass;

    @WithFactory
    public ContextType(String name, int ordinal, ContextInfectivityClasses contextInfectivityClasses, @ByName("infectivity-class") String infectivityClass) {
        super(name, ordinal);
