 ...
 public class Covid19StageTransitionsProvider implements LookupTransitionsProvider {
     ...
     @WithFactory
     public Covid19StageTransitionsProvider(@ByName("pdyn2.infectivity.progression.lookup.lookup-data-provider.covid19-stage-transitions-provider.wild") String wildStageTransitionsFilename,
                                            @ByName("pdyn2.infectivity.progression.lookup.lookup-data-provider.covid19-stage-transitions-provider.alpha") String alphaStageTransitionsFilename,
                                            @ByName("pdyn2.infectivity.progression.lookup.lookup-data-provider.covid19-stage-transitions-provider.delta") String deltaStageTransitionsFilename,
                                            @ByName("pdyn2.infectivity.progression.lookup.lookup-data-provider.covid19-stage-transitions-provider.ba1") String ba1StageTransitionsFilename,
                                            @ByName("pdyn2.infectivity.progression.lookup.lookup-data-provider.covid19-stage-transitions-provider.ba2") String ba2StageTransitionsFilename,
                                            Loads loads,
                                            WorkDir workDir,
                                            Stages stages,
                                            AgeRanges ageRanges) {
