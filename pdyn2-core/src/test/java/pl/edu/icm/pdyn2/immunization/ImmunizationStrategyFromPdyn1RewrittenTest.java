...
class ImmunizationStrategyFromPdyn1RewrittenTest {
    ...
    @BeforeEach
    void setup() {
        immunizationEvent1.setLoad(data.alpha);
        immunizationEvent1.setDay(1);
        immunizationEvent2.setLoad(data.ba45);
    ...
    void getImmunizationCoefficient() {
        ...
        //execute
        var coef1 = immunizationStrategy.getImmunizationCoefficient(immunization1, ImmunizationStage.LATENTNY, data.omicron, 73);
        var coef2 = immunizationStrategy.getImmunizationCoefficient(immunization2, ImmunizationStage.LATENTNY, data.omicron, 73);
        //assert
