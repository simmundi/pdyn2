...
public class StatsOutputSystem implements EntitySystem {
    ...
    @WithFactory
    public StatsOutputSystem(StatsService statsService, SimulationClock simulationClock, TransmissionConfig transmissionConfig) {
    ...
    public void execute(SessionFactory sessionFactory) {
        System.out.println(simulationClock.getCurrentDate() + " (day " + simulationClock.getDaysPassed() + ")");
