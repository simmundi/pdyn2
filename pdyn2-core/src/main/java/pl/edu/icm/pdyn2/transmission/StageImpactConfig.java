...
public class StageImpactConfig {
    ...
    @WithFactory
    public StageImpactConfig(@ByName("pdyn2.infectivity.transmission.contexts.stage-impact.INFECTIOUS_ASYMPTOMATIC") float asymptomaticInfluenceShare,
                             @ByName("pdyn2.infectivity.transmission.contexts.stage-impact.INFECTIOUS_SYMPTOMATIC") float symptomaticInfluenceShare,
                             Stages stages) {
