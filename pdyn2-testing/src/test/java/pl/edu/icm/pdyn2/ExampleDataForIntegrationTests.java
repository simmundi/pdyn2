...
public class ExampleDataForIntegrationTests {
    ...
    public ExampleDataForIntegrationTests(BasicConfig basicConfig, boolean sharedSession) {
        ...
        agent1 = session.createEntity(person(18, Person.Sex.M),
                inhabitant(householdContext1, school1), health(basicConfig.WILD, basicConfig.HEALTHY), behaviour(BehaviourType.ROUTINE));
        ...
        agent4 = session.createEntity(person(18, Person.Sex.M),
                inhabitant(householdContext2, school1), health(basicConfig.WILD, basicConfig.HEALTHY), behaviour(BehaviourType.ROUTINE));
        agent5 = session.createEntity(person(18, Person.Sex.M),
                inhabitant(householdContext2, school1), health(basicConfig.WILD, basicConfig.HEALTHY), behaviour(BehaviourType.ROUTINE));
        agent6 = session.createEntity(person(18, Person.Sex.M),
                inhabitant(householdContext2, school2), health(basicConfig.WILD, basicConfig.HEALTHY), behaviour(BehaviourType.ROUTINE));
        agent7 = session.createEntity(person(18, Person.Sex.M),
                inhabitant(householdContext3, school2), health(basicConfig.WILD, basicConfig.HEALTHY), behaviour(BehaviourType.ROUTINE));
        ...
        agentA = session.createEntity(person(18, Person.Sex.M),
                inhabitant(householdContext3, workplace, school2), health(basicConfig.WILD, basicConfig.HEALTHY), behaviour(BehaviourType.ROUTINE));
        allAgents = List.of(agent1, agent2, agent3, agent4, agent5, agent6, agent7, agent8, agent9, agentA);
        householdContext1.add(ComponentCreator.household(List.of(agent1, agent2, agent3)));
        householdContext2.add(ComponentCreator.household(List.of(agent4, agent5, agent6)));
        householdContext3.add(ComponentCreator.household(List.of(agent7, agent8, agent9, agentA)));
    }
