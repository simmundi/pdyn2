...
class TestingServiceTest {
    ...
    void maybeTestAgent() {
        // given
        HealthStatus healthStatus = ComponentCreator.health(basicConfig.WILD, basicConfig.INFECTIOUS_SYMPTOMATIC);
        HealthStatus healthy = ComponentCreator.health(basicConfig.WILD, basicConfig.HEALTHY);
